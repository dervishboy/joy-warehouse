        ...
        <div className="p-4">
            <div className="col-span-8">
                <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                    <div className="flex items-center p-4 border-2 border-custom-jhitam hover:bg-orange-300 rounded-lg shadow-xs mt-4 cursor-pointer">
                    ...
                    <div className="flex items-center p-4 border-2 border-custom-jhitam hover:bg-rose-300 rounded-lg shadow-xs mt-4 cursor-pointer">
                    ...
                    <div className="flex items-center p-4 border-2 border-custom-jhitam hover:bg-lime-300 rounded-lg shadow-xs mt-4 cursor-pointer">
                        <div className="p-3 mr-4 text-white bg-custom-jhitam rounded-full">
