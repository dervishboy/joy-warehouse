...
import { Container, Grid, Paper, TextField, Button, MenuItem, Select, FormControl, IconButton, Typography, Box } from "@mui/material";
...
export default function TambahPesanan() {
    ...
    useEffect(() => {
        ...
        const mockMaterials = [
            { id: 1, nama_material: 'Material X', quantity: '100' },
            { id: 2, nama_material: 'Material Y', quantity: '200' }
        ];
